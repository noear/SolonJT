...
public class EnjoyJtActuator implements IJtActuator {
    private static final String _lock = "";
    private static EnjoyJtActuator _g;

    public static EnjoyJtActuator singleton() {
        if (_g == null) {
            synchronized (_lock) {
                if (_g == null) {
                    _g = new EnjoyJtActuator();
                }
            }
        }
