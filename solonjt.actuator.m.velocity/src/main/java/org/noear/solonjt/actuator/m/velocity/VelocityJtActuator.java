package org.noear.solonjt.actuator.m.velocity;
...
public class VelocityJtActuator implements IJtActuator {
    ...
    private VelocityJtActuator() {
        ...
        p.setProperty("string.resource.loader.class",
                "org.noear.solonjt.actuator.m.velocity.StringResourceLoaderEx");
        p.setProperty("string.resource.loader.repository.class",
                "org.noear.solonjt.actuator.m.velocity.StringResourceRepositoryEx");  //这是自定义的获取模板实现
