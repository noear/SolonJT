...
import org.noear.thinkjt.extend.sited.dao.DbSiteDApi;
import org.noear.thinkjt.extend.sited.dao.DbUtil;
import org.noear.thinkjt.extend.sited.dao.Utils;
import org.noear.thinkjt.extend.sited.utils.*;
import org.noear.thinkjt.extend.sited.dao.custom.DdApi;
...
public class eSiteD {
    ...
    public String sourceSet(String puid, String path, String content)throws Exception {
        ...
        DbSiteDApi.saveSiteD(puid2, sd, path);
