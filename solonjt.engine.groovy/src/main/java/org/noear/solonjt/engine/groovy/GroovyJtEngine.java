...
public class GroovyJtEngine implements IJtEngine {
        private static final ThData<StringBuilder> _tlBuilder = new ThData(new StringBuilder(1024*5));
        private static final String _lock ="";
        private static GroovyJtEngine _g;
        public static GroovyJtEngine singleton(){
            if(_g == null){
                synchronized (_lock){
                    if(_g == null){
                        _g = new GroovyJtEngine();
                    }
                }
            }
        ...
        public static class __JTEAPI {
            public String require(String path) throws Exception {
                ...
                GroovyJtEngine.singleton().preLoad(name2, file);
